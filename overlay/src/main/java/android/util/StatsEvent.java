...
public final class StatsEvent {
    ...
    private StatsEvent(final int atomId, final Buffer buffer,
            final byte[] payload, final int numBytes) {
        mAtomId = atomId;
        mBuffer = buffer;
        mPayload = payload;
        mNumBytes = numBytes;
    ...
    public static final class Builder {
        ...
        private void writeByteArray(final byte[] value, final byte typeId) {
            writeTypeId(typeId);
        ...
        public Builder writeKeyValuePairs(
            final SparseIntArray intMap,
            final SparseLongArray longMap,
            final SparseArray<String> stringMap,
            final SparseArray<Float> floatMap) {
        ...
        private static byte[] stringToBytes(final String value) {
    ...
    private static final class Buffer {
         ...
         * @return number of bytes written to buffer from this write operation.
         **/
        private int putByteArray(final int index, final byte[] value) {
            final int numBytes = value.length;
